...
### All mixed
- `ng build --prod && ng run angular-universal:server && npm run webpack:server && cp -a functions/dist/browser/. public/ && mv public/index.html public/index2.html && firebase deploy`
...
thats because you have more than one main modules on your app, app.module and app.server.module, so you need to use `ng g c home --module app` to generate a component/etc. 
